...
static int gpio_reserved_pin_rev_zero[] = {
	0, 1, 2, 3, 34, 53, 54, 55, 73, 74, 76, 77, 78, 82, 83, 84, 89, 90, 94, 95, 96, 97, 98, 103, 104, 107, 112, 115, 116, 117, 118,
...
/*
Rev B gpio 60 for DSV_EN    Rev 1_0 gpio 0 for touch_reset
*/
static int gpio_reserved_pin_rev_B[] = {
	34, 53, 55, 56, 75, 76, 77, 78, 79, 82, 91, 92, 93, 94, 97, 98, 104, 107, 111, 112, 116, 117, 118,
	MSM8x26_GPIO_END // This is included to notify the end of reserved GPIO configuration.
	};
...
static struct msm_gpiomux_config msm_i2c_configs[] __initdata = {
	...
	{
		.gpio      = 10,	/* HW_REV_1_0_TOUCH_I2C_SDA */
		.settings = {
	...
	{
		.gpio      = 11,	/* HW_REV_1_0_TOUCH_I2C_SCL */
		.settings = {
			[GPIOMUX_ACTIVE] = &touch_gpio_i2c_act_config,
			[GPIOMUX_SUSPENDED] = &touch_gpio_i2c_sus_config,
		},
...
static struct msm_gpiomux_config msm8926_nfc_configs[] __initdata = {
    {
        /* I2C SDA */
        .gpio      = 22,
        .settings = {
...
static struct msm_gpiomux_config msm8926_nfc_rev10_configs[] __initdata = {
    {
        /* I2C SDA */
        .gpio      = 22,
        .settings = {
...
#if defined(CONFIG_LGE_TOUCHSCREEN_SYNAPTIC) || defined(CONFIG_TOUCHSCREEN_SYNAPTICS_I2C_RMI4)
static struct msm_gpiomux_config msm_touch_rev1_configs[] __initdata = {
	{
		.gpio = 17,
		.settings = {
			[GPIOMUX_ACTIVE] = &synaptics_attn_cfg,
...
void __init msm8226_init_gpiomux(void)
{
	...
	// GPIO related function <<4.TOUCH>>
	 if(hw_rev >= HW_REV_1_0 ) {
        msm_gpiomux_install(msm_touch_rev1_configs, ARRAY_SIZE(msm_touch_rev1_configs));
		printk(KERN_ERR "[Touch] HW_Rev_1_0 or above \n");
    } else {
        msm_gpiomux_install(msm_touch_configs, ARRAY_SIZE(msm_touch_configs));
	    printk(KERN_ERR "[Touch] HW_Rev_A or B or C or D or E \n");
    }
...
/*                                                       */
    ...
    if(hw_rev < HW_REV_1_0) {
    msm_gpiomux_install(msm8926_nfc_configs, ARRAY_SIZE(msm8926_nfc_configs));
    } else {
        msm_gpiomux_install(msm8926_nfc_rev10_configs, ARRAY_SIZE(msm8926_nfc_rev10_configs));
    }
