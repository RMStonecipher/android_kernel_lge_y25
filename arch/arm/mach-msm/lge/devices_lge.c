...
#if defined(CONFIG_LGE_FOTA_CHECK)
static int lge_fota_mode = 0;

int __init lge_fota_mode_init(char *s)
{
    if (!strcmp(s, "enable"))
        lge_fota_mode = 1;
...
__setup("lge.fota=", lge_fota_mode_init);

int lge_get_fota_mode(void)
{
    return lge_fota_mode;
}
#endif
...
char *rev_str[] = {"rev_0", "rev_a", "rev_b", "rev_c", "rev_d",
	"rev_e", "rev_10", "rev_11", "rev_12", "rev_13", "rev_14", "revserved"};
#elif defined(CONFIG_MACH_MSM8926_E8LTE_KR)
char *rev_str[] = {"rev_0", "rev_a", "rev_b", "rev_c", "rev_d",
...
#if defined(CONFIG_MACH_MSM8X10_W5) || defined(CONFIG_MACH_MSM8X10_W65) || defined(CONFIG_MACH_MSM8X10_Y30)
// 0 is primary
// 1 is secondary
// 4 is unknown
int lge_lcd_id = 4;
