...
static int set_battery_data(struct qpnp_bms_chip *chip)
{
	...
	batt_data = &LGC_BL44JN_1540mAh_data;
#else
	switch ( battery_id ){
	...
	switch ( battery_id ){
		...
		case BATT_ID_DS2704_L : // FALL THROUGH
            ...
            batt_data = &LGE_BL41ZH_LGC_Y30_1900mAh_BMS_data;
#else
		...
		case BATT_ID_ISL6296_L : // FALL THROUGH
#ifdef CONFIG_MACH_MSM8X10_Y30
            batt_data = &LGE_BL41ZH_Tocad_Y30_1900mAh_BMS_data;
#else
		...
		case BATT_ID_RA4301_VC0 :
			batt_data = &LGE_BL41ZH_BYD_Y30_1900mAh_BMS_data;
			pr_err("[BATTERY PROFILE] Using BYD profile - BYD_1900mAh for id(%d)\n",battery_id);
			break;
#endif
		case BATT_ID_ISL6296_C : // FALL THROUGH
		default :
