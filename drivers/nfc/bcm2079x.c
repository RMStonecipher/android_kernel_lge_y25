...
static void bcm2079x_get_clk_source(struct bcm2079x_dev *bcm2079x_dev)
{
    bcm2079x_dev->clk_cont = &cxo_d1.c;
    bcm2079x_dev->s_clk = &cxo_d1_pin.c;
}
               ...
               const struct i2c_device_id *id)
{
    ...
    bcm2079x_get_clk_source(bcm2079x_dev);
