					...
					struct mdp_display_commit *cmt_data)
{
	...
	if (reset_done && (panel && panel->set_backlight)){
		...
		mdelay(50); /* To fix whitescreen before LG logo animation starts */
#endif
...
#if defined(CONFIG_FB_MSM_MIPI_TIANMA_CMD_HVGA_PT) || defined(CONFIG_MACH_MSM8X10_W5) || defined(CONFIG_MACH_MSM8X10_W6) || defined(CONFIG_MACH_MSM8X10_L70P) || defined(CONFIG_MACH_MSM8X10_Y30)
	bool reset_done = false;
	struct mdss_panel_data *panel;
#endif
