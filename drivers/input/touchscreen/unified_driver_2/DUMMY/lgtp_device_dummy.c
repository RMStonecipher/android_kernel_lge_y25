...
* Variables
****************************************************************************/
static const char defaultFirmware[] = "dummy/dummy_firmware.img";
...
//====================================================================
static int Dummy_QueryDeviceConnection(void)
{
	TOUCH_FUNC();
...
static int Dummy_UpdateFirmware(struct i2c_client *client, char *pFilename,TouchFirmwareInfo *pFwInfo)
{
	int ret = 0;
	const struct firmware *fw = NULL;
	u8 *pBin = NULL;
...
TouchDeviceSpecificFunction Dummy_Func = {
	...
	.Reset = Dummy_Reset,
	.Connect = Dummy_QueryDeviceConnection,
