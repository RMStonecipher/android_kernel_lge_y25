...
int Lu201x_I2C_Read ( struct i2c_client *client, u16 addr, u8 *rxbuf, int len )
{
	int ret = 0;
...
int Lu201x_I2C_Write ( struct i2c_client *client, u16 addr, u8 *txbuf, int len )
{
	int ret = 0;
	u8 regValue[2] = { ( (addr>>8) & 0xFF ), ( addr & 0xFF ) };
...
int Lu202x_I2C_Read ( struct i2c_client *client, u16 addr, u8 *rxbuf, int len )
{
	int ret = 0;
	u8 regValue[2] = { ( (addr>>8) & 0xFF ), ( addr & 0xFF ) };
...
int Lu202x_I2C_Write ( struct i2c_client *client, u16 addr, u8 *txbuf, int len )
{
	int ret = 0;
	u8 regValue[2] = { ( (addr>>8) & 0xFF ), ( addr & 0xFF ) };
