...
#if defined(CONFIG_MACH_MSM8X10_W5) || defined(CONFIG_MACH_MSM8X10_W6) || defined(CONFIG_MACH_MSM8X10_L70P) || defined(CONFIG_MACH_MSM8X10_Y30)
	{
...
static struct msm_camera_i2c_reg_conf hi707_cowell_recommend_settings[] = {
	...
	//최종 업데이트 : 20130315
		...
		{0x13, 0x19},
		{0x14, 0x08},	//Test Setting
#if defined(CONFIG_MACH_MSM8926_VFP_KR) //2014.09.05 js.kim SelfCAM Face brightness UP
...
{0x12, 0x30},
{0x40, 0x80},
#if defined(CONFIG_MACH_MSM8926_VFP_KR)//for 8fps tuning_js.kim
{0x41, 0x26},//16}, //DYOFS 02
{0x48, 0x80},
