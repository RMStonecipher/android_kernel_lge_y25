...
#if !(defined(CONFIG_MACH_MSM8926_VFP_KR) || defined(CONFIG_MACH_MSM8926_E2JPS_JP))
...
#if defined(CONFIG_IMX179) || defined(CONFIG_IMX219) || defined(CONFIG_IMX091)
	#if defined(CONFIG_MACH_MSM8926_VFP_KR) || defined(CONFIG_MACH_MSM8926_E2JPS_JP)
	// Do not execute msm_actutator_StablePosition() since main -> vt switch issue.
	#else
...
static int32_t msm_actuator_power_up(struct msm_actuator_ctrl_t *a_ctrl)
{
	...
	CDBG("vcm info: vcm_pwd: %x vcm_enable: %x\n", a_ctrl->vcm_pwd,
		a_ctrl->vcm_enable);
	if (a_ctrl->vcm_enable) {
