...
#if defined(CONFIG_MACH_MSM8226_E7WIFI) || defined(CONFIG_MACH_MSM8226_E8WIFI) || defined(CONFIG_MACH_MSM8X10_Y25C_TRF_US) || defined(CONFIG_MACH_MSM8X10_Y25_TRF_US)
...
/*                                                                                                        */
	...
	defined(CONFIG_MACH_MSM8X10_W3C_VZW) || defined(CONFIG_MACH_MSM8X10_Y25C_TRF_US) || defined(CONFIG_MACH_MSM8X10_Y25_TRF_US)
	{
...
/*                                                                                                              */
#if defined(CONFIG_MACH_MSM8X10_Y25C_TRF_US) || defined(CONFIG_MACH_MSM8X10_Y25_TRF_US)
static struct msm_sensor_power_setting hi351_power_setting_y25_revA[] = {
	{
		.seq_type = SENSOR_GPIO,
		.seq_val = SENSOR_GPIO_RESET,
		.config_val = GPIO_OUT_LOW,
	...
	const struct i2c_device_id *id)
{
	...
	if(gpio_is_valid(71)){
		...
		pr_err("[Y25] main_cam_id_value = %d \n",main_cam_id_value);
#endif
...
/*                                                                                                      */
#elif defined(CONFIG_MACH_MSM8X10_Y25C_TRF_US) || defined(CONFIG_MACH_MSM8X10_Y25_TRF_US)
	switch(lge_get_board_revno()) {
		case HW_REV_A:
			pr_err("[Y25] %s: Sensor power is set as Rev.A ..., line(%d)\n", __func__, __LINE__);
			hi351_s_ctrl.power_setting_array.power_setting = hi351_power_setting_y25_revA;
			hi351_s_ctrl.power_setting_array.size = ARRAY_SIZE(hi351_power_setting_y25_revA);
			break;
		default:
			pr_err("[Y25] %s: Sensor power is set as default, line(%d)\n", __func__, __LINE__);
			hi351_s_ctrl.power_setting_array.power_setting = hi351_power_setting;
			hi351_s_ctrl.power_setting_array.size = ARRAY_SIZE(hi351_power_setting);
			break;
	}
...
/*                                                                                                      */
#if !(defined(CONFIG_MACH_MSM8226_E7WIFI) || defined(CONFIG_MACH_MSM8X10_Y25C_TRF_US) || defined(CONFIG_MACH_MSM8X10_Y25_TRF_US))
